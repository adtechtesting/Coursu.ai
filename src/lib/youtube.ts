...
export async function youtube_api(searchQuery:string){
...
export async function getTranscriptQuestions(transcript:string,course_title:string){
        type Question={
          question:string,
          answer:string,
          option1:string,
